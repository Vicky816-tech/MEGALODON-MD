...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~DxwRETIS#_wnsLwtBD5IpS-MO6rJJ0HIowbODqX9lVDmEjd2TkO0",  // Your bot's session ID (keep it secure)
    ...
    REJECT_MSG: process.env.REJECT_MSG || "*📞 ᴄαℓℓ me latter 📵*",
