...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~ABo2nQbJ#14agtpB9LjHn3X3gSCfxxIC8ucZm1mVFRQKEEeRzEvg",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "𝚂𝚊𝚜𝚞𝚔𝚎~𝚖𝚍",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || "𝚜𝚊𝚜𝚞𝚔𝚎",           // Owner's name
